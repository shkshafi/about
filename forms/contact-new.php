...
$my_email = "shaik.shafi.ur.rahman@gmail.com";
...
/* Site URL */
$site_url = $_POST['subject'];

/* Site Name */
$site_name = "https://shkshafi.github.io/portfolio/";
...
$message = $message . PHP_EOL.PHP_EOL."-- ".PHP_EOL."Thank you for contacting Us.";
